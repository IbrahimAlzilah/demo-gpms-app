...
export const dashboardService = {
  ...
  getStudentDashboard: async (): Promise<StudentDashboardData> => {
    const response =
      await apiClient.get<StudentDashboardData>("/student/dashboard");
    return response.data;
  },

  // Supervisor Dashboard
  getSupervisorDashboard: async (): Promise<SupervisorDashboardData> => {
    const response = await apiClient.get<SupervisorDashboardData>(
      "/supervisor/dashboard",
    );
    return response.data;
  },
  ...
  getProjectsCommitteeDashboard:
    async (): Promise<ProjectsCommitteeDashboardData> => {
  ...
  getDiscussionCommitteeDashboard:
    async (): Promise<DiscussionCommitteeDashboardData> => {
