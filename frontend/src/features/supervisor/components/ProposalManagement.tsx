...
import { SupervisorProposalForm } from './ProposalForm'
import type { Proposal } from '../../../types/project.types'
import { createProposalColumns } from '@/pages/student/proposals/components/table'
...
export function SupervisorProposalManagement() {
  ...
  const {
    ...
    queryFn: (params) => {
      ...
      return supervisorProposalService.getTableData({ ...params, filters })
    },
    initialPageSize: 10,
