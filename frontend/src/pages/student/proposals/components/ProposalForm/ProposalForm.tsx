        ...
        {(isRegistrationWindow || studentGroup) && (
          <div className="space-y-2">
            ...
            {studentGroup && (() => {
              ...
              // During proposal submission window: allow submission regardless of group size
              // During registration window: enforce minimum member requirement
              const isValidSize = isRegistrationWindow 
                ? totalMembers >= minMembers && totalMembers <= maxMembers
                : totalMembers <= maxMembers // Only check max during proposal submission
                    ...
                    <p className="text-xs text-destructive flex items-center gap-1">
                      ...
                      {isRegistrationWindow 
                        ...
                        : totalMembers > maxMembers 
                          ? `Group cannot have more than ${maxMembers} members`
                          : t('proposal.validation.groupSizeInvalid')
                      }
                    </p>
                  )}
