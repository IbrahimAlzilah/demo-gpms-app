 ...
 */
export type SubmissionOrigin = "student_group" | "supervisor" | "committee";
...
/**
 * Committee submission - proposals added directly by the committee
 */
export interface CommitteeSubmission extends GroupedSubmission {
  origin: "committee";
  submitter: User | null; // Committee member who added the proposal
}
