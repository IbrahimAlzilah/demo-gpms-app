...
class ProposalResource extends JsonResource
{
    ...
    public function toArray(Request $request): array
    {
        return [
            ...
            'assignedToGroupId' => $this->assigned_to_group_id ? (string) $this->assigned_to_group_id : null,
            'assignmentType' => $this->assignment_type,
            'assignedAt' => $this->assigned_at?->toISOString(),
            'assignedToGroup' => new StudentGroupResource($this->whenLoaded('assignedToGroup')),
