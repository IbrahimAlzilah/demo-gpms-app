...
class GradeResource extends JsonResource
{
    ...
    public function toArray(Request $request): array
    {
        ...
        return [
            ...
            'isFd1Approved' => $fd1ApprovalStatus === 'approved' || $fd1ApprovalStatus === 'published',
            'isFd2Approved' => $fd2ApprovalStatus === 'approved' || $fd2ApprovalStatus === 'published',
            'fd1Published' => $fd1ApprovalStatus === 'published',
            'fd2Published' => $fd2ApprovalStatus === 'published',
